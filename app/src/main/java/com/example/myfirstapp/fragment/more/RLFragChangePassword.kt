...
import com.example.myfirstapp.databinding.RlFragChangePasswordBinding
...
class RLFragChangePassword : RLBaseFragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        RLPrefManager.RLsetSomeStringValue(activity, RLPrefManager.current_fragment,"RLFragChangePassword" )
