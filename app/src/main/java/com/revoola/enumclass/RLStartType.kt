...
enum class RLStartType (val title: String, val type: String, val description:Int, val img:String) {
    ...
    Calories("CALORIES",  ic_challenges_calories,R.string.mindclassdescription,
        img_challenges_calories
    ),
    Distance("DISTANCE", ic_challenges_distance,R.string.mindclassdescription,
        img_challenges_distance
    ),
    Climbed("CLIMBED", ic_challenges_climbed,R.string.mindclassdescription, img_challenges_climbed),
    Duration("DURATION", ic_challenges_duration,R.string.mindclassdescription,
        img_challenges_duration
    ),
    ...
    InviteToJoin("INVITE TO JOIN", ic_friend_invite,R.string.mindclassdescription,
        img_friend_invite
    )
}
