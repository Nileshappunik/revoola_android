...
object RLTools {
    ...
    fun RLgetImage(typename:String): String {
        if (typename.isNullOrEmpty()){
            return com.revoola.utils.RLConstants.Companion.WALKIMAGE
        }
        if( typename.toLowerCase().equals("walk")){
            return com.revoola.utils.RLConstants.Companion.WALKIMAGE
        }else if( typename.toLowerCase().equals("run")){
            return com.revoola.utils.RLConstants.Companion.RUNIMAGE
        }else if( typename.toLowerCase().equals("yoga")){
            return com.revoola.utils.RLConstants.Companion.YOGAIMAGE
        }else if( typename.toLowerCase().equals("pilates")){
            return com.revoola.utils.RLConstants.Companion.PILATESIMAGE
        }else if( typename.toLowerCase().equals("ride")){
            return com.revoola.utils.RLConstants.Companion.RIDEIMAGE
        }else if( typename.toLowerCase().equals("workout")){
            return com.revoola.utils.RLConstants.Companion.WORKOUTIMAGE
        }else if (typename.toLowerCase().equals("challenge-effort")){
            return com.revoola.utils.RLConstants.Companion.img_challenge_start
        }else if (typename.toLowerCase().equals("challenge-steps")){
            return com.revoola.utils.RLConstants.Companion.img_challenge_start
        }else if (typename.toLowerCase().equals("challenge-calories")){
            return com.revoola.utils.RLConstants.Companion.img_challenge_start
    ...
    fun RLdialogBox(activity: Activity, msg: String?) {
        ...
        alertDialogBuilder.setPositiveButton(
            "Ok"
        ) { arg0, arg1 -> com.revoola.utils.RLTools.RLstartApp(activity) }
        val alertDialog = alertDialogBuilder.create()
        alertDialog.show()
    }
