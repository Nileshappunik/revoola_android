...
data class RLTextOverviewOld(
    ...
    val totalRMM: String = "",
    val totalRMS: String = "",
    val maxRevPercentage: Double = 0.0,
    val avgRevPercentage: String = "",
    val zone1Seconds: String = "",
    val zone2Seconds: String = "",
    val zone3Seconds: String = "",
    ...
    val zone7Seconds: String = "",
    val medals: String = "",
    val medals_gold: Int = 0,
    val medals_silver: Int = 0,
    val medals_bronze: Int = 0,
    val awards: String = "",
    ...
    val goal: String = "",
    val avatarKudos: String = "",
    val avatar_comments: String? = null,
    val total_kudos: Int = 0,
    ...
    val user_images: String = "",
    val isDeleted: Int = 0,
    val dems: String? = null,
    val spike_steps: String? = null,
    val spike_timestamp: String? = null,
    val share_map: Int = 0,
    val from_third_party_source: Int = 0,
...
data class RLtrigger_inapp_referrer_goaled_challenges_Request(var trigger_inapp_referrer_goaled_challenges: RLtrigger_inapp_referrer_goaled_challenges)
data class RLtrigger_inapp_referrer_goaled_challenges(var userid: String,var inapp_referrer:String, var challengeid:String)
